    ...
    return (
      <ul className={classnames(ulClassName)}>
        {filteredList.map((item, index) => {
          ...
          return (
            <li key={index} className={classnames(liClassName, isActive && activeLiClassName)}>
              {hyperlink ? (
                <a href={href} className={classnames(anchorClassName, isActive && activeAnchorClassName)}>
                  {text}
                </a>
              ) : (
                text
