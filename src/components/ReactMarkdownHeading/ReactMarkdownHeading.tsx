...
import parseHeadingText, { Heading as HeadingType } from './util/parseHeadingText'
...
export const ReactMarkdownHeading: React.FC<ReactMarkdownHeadingProps> = ({
  markdown,
  ulClassName,
  liClassName,
  anchorClassName,
  ...
  const parsedHeadingList = useMemo(
    ...
    [headingList, blankSpaceReplaceText, hyperLinkPrefix],
  )
